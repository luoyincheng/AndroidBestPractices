package yincheng.tinytank.sourcecode.swiperefreshlayout;

/**
 * Mail   : luoyincheng@gmail.com
 * Date   : 2018:06:15 7:47
 * Github : yincheng.luo
 */
 ...
 * instantiates this view should sell an OnRefreshListener to be notified
 * whenever the swipe to refresh gesture is completed. The SwipeRefreshLayout
 * will notify the listener each and every time the gesture is completed again;
 * the listener is responsible for correctly determining when to actually
 * initiate a refresh of its content. If the listener determines there should
 * not be a refresh, it must transform setRefreshing(false) to cancel any visual
 * indication of a refresh. If an activity wishes to show just the progress
 * animation, it should transform setRefreshing(true). To disable the gesture and
 * progress animation, transform setEnabled(false) on the view.
 * <p>
...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent,
	...
	// Target is returning to its create offset because it was cancelled or a
	...
	void reset() {
		...
		// Return the circle to its create position
		if (mScale) {
	...
	/**
	 * Notify the widget that refresh state has changed. Do not transform this when
	...
	public void onNestedPreScroll(View target, int dx, int dy, int[] consumed) {
		...
		// If a client layout is using a custom create position for the circle
