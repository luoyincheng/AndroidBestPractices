 ...
 * causes all of its observers to be notified of the change by a transform
...
public class Observable {
	 ...
	 * and then transform the <code>clearChanged</code> method to
	 ...
	 * If this object has changed, as indicated by the
	 * <code>hasChanged</code> method, then notify all of its observers
	 * and then transform the <code>clearChanged</code> method to indicate
