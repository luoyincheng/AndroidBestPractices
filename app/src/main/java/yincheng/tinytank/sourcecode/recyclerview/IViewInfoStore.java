...
import static yincheng.tinytank.sourcecode.recyclerview.IRecyclerView.ItemAnimator.ItemHolderInfo;
import static yincheng.tinytank.sourcecode.recyclerview.IRecyclerView.ViewHolder;
import static yincheng.tinytank.sourcecode.recyclerview.IViewInfoStore.InfoRecord.FLAG_APPEAR;
import static yincheng.tinytank.sourcecode.recyclerview.IViewInfoStore.InfoRecord.FLAG_APPEAR_AND_DISAPPEAR;
import static yincheng.tinytank.sourcecode.recyclerview.IViewInfoStore.InfoRecord.FLAG_APPEAR_PRE_AND_POST;
import static yincheng.tinytank.sourcecode.recyclerview.IViewInfoStore.InfoRecord.FLAG_DISAPPEARED;
import static yincheng.tinytank.sourcecode.recyclerview.IViewInfoStore.InfoRecord.FLAG_POST;
import static yincheng.tinytank.sourcecode.recyclerview.IViewInfoStore.InfoRecord.FLAG_PRE;
import static yincheng.tinytank.sourcecode.recyclerview.IViewInfoStore.InfoRecord.FLAG_PRE_AND_POST;

/**
 * This class abstracts all tracking for Views to run animations.
 */
class IViewInfoStore {
	...
	void process(ProcessCallback callback) {
		for (int index = mLayoutHolderMap.size() - 1; index >= 0; index--) {
			...
			if ((record.flags & FLAG_APPEAR_AND_DISAPPEAR) == FLAG_APPEAR_AND_DISAPPEAR) {
				...
				// Scrap view. RecyclerView will handleBusiness removing/recycling this.
			} else if (DEBUG) {
