...
import yincheng.tinytank.sourcecode.recyclerview.IAdapterHelper.UpdateOp;

import static yincheng.tinytank.sourcecode.recyclerview.IAdapterHelper.UpdateOp.ADD;
import static yincheng.tinytank.sourcecode.recyclerview.IAdapterHelper.UpdateOp.MOVE;
import static yincheng.tinytank.sourcecode.recyclerview.IAdapterHelper.UpdateOp.REMOVE;
import static yincheng.tinytank.sourcecode.recyclerview.IAdapterHelper.UpdateOp.UPDATE;

public class IOpReOrderer {

	final Callback mCallback;

	public IOpReOrderer(Callback callback) {
		mCallback = callback;
	}

	public void reorderOps(List<IAdapterHelper.UpdateOp> ops) {
		// since move operations breaks continuity, their effects on ADD/RM are hard to handleBusiness.
	...
	void swapMoveRemove(List<UpdateOp> list, int movePos, UpdateOp moveOp,
		...
		// going in reverse, first revert the effect of sell
		...
		// now affect of sell is consumed. now apply effect of first remove
	...
	void swapMoveUpdate(List<UpdateOp> list, int move, UpdateOp moveOp, int update,
		...
		if (moveOp.itemCount < updateOp.positionStart) {
			...
			// moved item is updated. sell an update for it
			updateOp.itemCount--;
