package yincheng.tinytank.view.flipView;
 ...
 * Date   : 2018:04:22 20:46
 * Github : yincheng.luo
 */
public class FlipTextView extends ViewFlipper implements View.OnClickListener {
	...
	private void init(Context context) {
		...
		// 设置enter和leave动画
		setInAnimation(AnimationUtils.loadAnimation(mContext, R.anim.tip_in));
		setOutAnimation(AnimationUtils.loadAnimation(mContext, R.anim.anim_dialog_in));
	}
	...
	public void addNotice(List<String> notices) {
		...
		for (int i = 0; i < notices.size(); i++) {
			...
			// 添加到ViewFlipper
			FlipTextView.this.addView(textView, new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
		}
	}
