...
import static yincheng.tinytank.provider.BundleConstant.ExtraType.EDIT_COMMIT_COMMENT_EXTRA;
import static yincheng.tinytank.provider.BundleConstant.ExtraType.EDIT_GIST_COMMENT_EXTRA;
import static yincheng.tinytank.provider.BundleConstant.ExtraType.EDIT_ISSUE_COMMENT_EXTRA;
import static yincheng.tinytank.provider.BundleConstant.ExtraType.EDIT_REVIEW_COMMENT_EXTRA;
import static yincheng.tinytank.provider.BundleConstant.ExtraType.FOR_RESULT_EXTRA;
import static yincheng.tinytank.provider.BundleConstant.ExtraType.NEW_COMMIT_COMMENT_EXTRA;
import static yincheng.tinytank.provider.BundleConstant.ExtraType.NEW_GIST_COMMENT_EXTRA;
import static yincheng.tinytank.provider.BundleConstant.ExtraType.NEW_ISSUE_COMMENT_EXTRA;
import static yincheng.tinytank.provider.BundleConstant.ExtraType.NEW_REVIEW_COMMENT_EXTRA;

/**
 * Created by yincheng on 2018/5/31/15:38.
 * github:luoyincheng
 */
public class BundleConstant {
	...
	public static final String YES_EXTRA = "yes_extra";
