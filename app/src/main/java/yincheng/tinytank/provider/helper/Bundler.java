...
/**
 * Created by yincheng on 2018/5/31/15:33.
 * github:luoyincheng
 */
public class Bundler {
	...
	public Bundler putParcelableArrayList(@NonNull String key, ArrayList<? extends Parcelable>
			value) {
		Bundle safeBundle = new Bundle();
	...
	public Bundler putSparseParcelableArray(@NonNull String key, SparseArray<? extends Parcelable>
			value) {
		Bundle safeBundle = new Bundle();
