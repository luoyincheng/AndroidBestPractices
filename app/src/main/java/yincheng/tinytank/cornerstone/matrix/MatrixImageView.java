...
public class MatrixImageView extends AppCompatImageView {
	...
	private void obtainAttrs(AttributeSet attrs) {
		...
		TypedArray typedArray = getContext()
				.obtainStyledAttributes(attrs, R.styleable.MatrixImageView);
		mMaxScaleFactor = typedArray.getFloat(
				R.styleable.MatrixImageView_max_scale, MAX_SCALE_FACTOR);
		mMinScaleFactor = typedArray.getFloat(
				R.styleable.MatrixImageView_min_scale, UNSPECIFIED_SCALE_FACTOR);
		mRevertDuration = typedArray.getInteger(
				R.styleable.MatrixImageView_revert_duration, DEFAULT_REVERT_DURATION);
		mOpenScaleRevert = typedArray.getBoolean(
				R.styleable.MatrixImageView_open_scale_revert, false);
		mOpenRotateRevert = typedArray.getBoolean(
				R.styleable.MatrixImageView_open_rotate_revert, false);
		mOpenTranslateRevert = typedArray.getBoolean(
				R.styleable.MatrixImageView_open_translate_revert, false);
		mOpenAnimator = typedArray.getBoolean(
				R.styleable.MatrixImageView_open_animator, true);
		mScaleBy = typedArray.getInt(
				R.styleable.MatrixImageView_scale_center, SCALE_BY_IMAGE_CENTER);
		typedArray.recycle();
	}
