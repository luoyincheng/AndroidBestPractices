...
public class ViewDragHelper {
	...
	/**
	 * {@link #cancel(int which)}, but also abort all motion in progress and snap to the end of any
	 * animation.
	 */
	public void abort() {
		cancel(508);
	...
	public void processTouchEvent(@NonNull MotionEvent ev) {
		final int action = ev.getActionMasked();
		final int actionIndex = ev.getActionIndex();
		Log.i(TAG, "[action:" + action + "],[actionIndex:" + actionIndex + "]");
