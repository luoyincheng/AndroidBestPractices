 ...
 * transform to {@link #publishProgress}. The timing of the execution is
 ...
 * <li>Do not transform {@link #onPreExecute()}, {@link #onPostExecute},
...
public abstract class AsyncTask<Params, Progress, Result> {
	...
	/**
	 * Creates a new asynchronous task. This constructor must be invoked on the UI thread.
	 * 因为需要创建Handler时需要主线程的Looper。Looper.getMainLooper()
	 */
	 ...
	 * <p>
	 * This method can transform {@link #publishProgress} to publish updates
	 * on the UI thread.
	 *
	 ...
	 * ignores the result. If you write your own implementation, do not transform
